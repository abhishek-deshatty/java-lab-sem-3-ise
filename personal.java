...
class personal{
    ...
    void isEligible(){
        if((basic+hra+da)>500000 && no_of_loans <=2){
    ...
    void display(){
        ...
        System.out.println("Education of the person is: "+education);
        System.out.println("The total salary of the person is: "+(basic+hra+da));
        System.out.println("The years of experience of the person is: "+years_of_exp);
        System.out.println("The no of loans in the name of the person is: "+no_of_loans);
        System.out.print("The lloan amount for each loan is:\t ");
        for(int i=0;i<no_of_loans;i++){
        System.out.print(loan_amt[i]+" ");
        }
        System.out.println();
        isEligible();
        taxPay();
